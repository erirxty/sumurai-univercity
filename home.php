              ...
              <div class="news_post_small">
                <div class="row news_post_row">
                  <div class="col-lg-3 col-md-4 col-sx-12">
                    <div class="calendar_border">
                      <div class="calendar_border_1">
                        <!-- <div class="calendar_month">OCT</div> カスタムフィールド更新時値の入れ忘れに注意-->
